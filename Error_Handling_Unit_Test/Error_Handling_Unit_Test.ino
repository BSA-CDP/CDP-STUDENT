...
const int redPin = ***FILL_IN_HERE***; // Define digital pin on Feather for Red (This can be any digital output pin)
const int greenPin = ***FILL_IN_HERE***; // Define digital pin on Feather for Green (This can be any digital output pin)
const int bluePin = ***FILL_IN_HERE***; // Define digital pin on Feather for Blue (This can be any digital output pin)
 ...
 // Log data to the file if the SD file can be found
  if (sdAvailable()) {
    ...
    while (***FILL_IN_HERE*** < maxRetries) {
      ...
      ***FILL_IN_HERE***; //increase count by 1
